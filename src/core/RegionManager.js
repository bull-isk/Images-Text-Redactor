...
export class RegionManager {
	...
	/**
	 * Sort regions into rough reading order (top-to-bottom, then
	 * left-to-right). Used before methods that read regions in sequence
	 * — e.g. FakeTextCensor's shared lorem-ipsum cursor — so the
	 * placeholder text advances in a natural order across the image.
	 */
	static sortReadingOrder(regions) {
